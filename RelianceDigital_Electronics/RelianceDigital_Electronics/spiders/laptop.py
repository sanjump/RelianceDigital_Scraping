...
class RelianceSpider(scrapy.Spider):
    name = 'reliancelaptop'
    pageno=2
    start_urls=['https://www.reliancedigital.in/laptops/c/S101210?searchQuery=:relevance:availability:Exclude%20out%20of%20Stock&page=0']
    ...
    def parse(self, response, **kwargs):
        ...
        page = 'https://www.reliancedigital.in/laptops/c/S101210?searchQuery=:relevance:availability:Exclude%20out%20of%20Stock&page=' + str(RelianceSpider.pageno)
