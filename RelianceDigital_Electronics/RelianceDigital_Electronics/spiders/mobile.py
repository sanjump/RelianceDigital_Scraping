...
class RelianceSpider(scrapy.Spider):
    name = 'reliancemobile'
    pageno=2
    start_urls=['https://www.reliancedigital.in/smartphones/c/S101711?searchQuery=:relevance&page=0']
    ...
    def parse(self, response, **kwargs):
        ...
        page = 'https://www.reliancedigital.in/smartphones/c/S101711?searchQuery=:relevance&page=' + str(RelianceSpider.pageno)
