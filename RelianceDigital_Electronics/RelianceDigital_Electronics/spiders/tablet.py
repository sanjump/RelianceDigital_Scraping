...
class RelianceSpider(scrapy.Spider):
    name = 'reliancetablet'
    pageno=2
    start_urls=['https://www.reliancedigital.in/tablets-ereaders/c/S101712?searchQuery=:relevance&page=0']
    ...
    def parse(self, response, **kwargs):
        ...
        page = 'https://www.reliancedigital.in/tablets-ereaders/c/S101712?searchQuery=:relevance&page=' + str(RelianceSpider.pageno)
